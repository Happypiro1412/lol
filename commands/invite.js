...
exports.run = (bot, message, args) => {
    ...
    .setThumbnail(bot.user.avatarURL)
        .addField(`Invite me on your server :kissing_heart:`, `[Invite link](https://discordapp.com/api/oauth2/authorize?client_id=722790472279523339&permissions=66452800&scope=bot)`, true)
